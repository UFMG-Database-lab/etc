...
from .AttentionTFIDF import AttentionTFIDF
from .ImbalancedTokenizer import ImbalancedTokenizer
...
class ETCClassifier(BaseEstimator):
    ...
    def fit(self, X_train, y_train, X_val, y_val):
        self.tknz      = ImbalancedTokenizer(**self.tknz)
    ...
    def predict(self, X):
        ...
        return self.tknzr.le.inferse_transform(y_preds) 
