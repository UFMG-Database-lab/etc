...
#mkdir -p pretrained_models/transfoxl/base
#cd pretrained_models/transfoxl/base
#wget https://huggingface.co/transfo-xl-wt103/resolve/main/pytorch_model.bin
#wget https://huggingface.co/transfo-xl-wt103/resolve/main/config.json
#cd $MYHOME

#mkdir -p pretrained_models/xlm/base
#cd pretrained_models/xlm/base
#wget https://huggingface.co/xlm-mlm-en-2048/resolve/main/pytorch_model.bin
#wget https://huggingface.co/xlm-mlm-en-2048/resolve/main/config.json
#cd $MYHOME
#
